...
🧠 System Overview
FalconEye converts user intent into persistent target tracking using the following pipeline: Perception & Tracking Pipeline
...
🏗️ Architecture
FalconEye uses a distributed architecture: System Architecture
